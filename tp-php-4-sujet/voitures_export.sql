...
--
-- Hôte : localhost:3306
-- Généré le : ven. 17 nov. 2023 à 09:46
...
(18, 'Lemonnier', 'Paul', '11 rue des carrières', 'Saint Lambert la Potherie', 49070);
...
('PAULBG', 'ZZZZZZZZZZ', 'foncée', '2023-11-16'),
...
--
ALTER TABLE `proprietaire`
  MODIFY `id_pers` mediumint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `cartegrise`
  ADD CONSTRAINT `cartegrise_ibfk_1` FOREIGN KEY (`id_pers`) REFERENCES `proprietaire` (`id_pers`),
  ADD CONSTRAINT `cartegrise_ibfk_2` FOREIGN KEY (`immat`) REFERENCES `voiture` (`immat`),
  ADD CONSTRAINT `cartegrise_ibfk_3` FOREIGN KEY (`id_pers`) REFERENCES `proprietaire` (`id_pers`);
...
ALTER TABLE `voiture`
  ...
  ADD CONSTRAINT `voiture_ibfk_2` FOREIGN KEY (`id_modele`) REFERENCES `modele` (`id_modele`);
COMMIT;
